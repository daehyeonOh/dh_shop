...
<div class="join">
    <div class="top">
        ...
        <div>
            ...
            <span class="end"><strong>03</strong> 가입완료</span>
        </div>
    </div>
    <div class="terms">
        <form id="formTerms" name="formTerms" method="post" action="../member/join.php">
            <input type="hidden" name="token" value="MTU1MTc1MjEzNDg0NTE2MzU1NTk0NzgyNDU3ODA3ODg4NDA2ODA3ODA3">
            ...
            <p class="all-agree">
                ...
                <label for="allAgree">
                    <span><strong>Simple의 모든 약관을 확인하고 전체 동의합니다.</strong></span>
                    (전체동의, 선택항목도 포함됩니다.)
                </label>
            </p>
            ...
            <div class="terms-view">
                <p>
                    ...
                    <a href="../service/agreement.php?code=001001" target="_blank">전체보기</a>
                </p>
...
표준약관 제10023호<br />
<br />
이 약관은 JNN 회사(전자거래 사업자)가 운영하는 Simple 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br />
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br />
<br />
<br />
제2조(정의)<br />
<br />
① "몰"이란 JNN 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br />
...
1. 이 약관은 년 월 일부터 적용됩니다.
            ...
            <div class="terms-view">
                <p>
                    ...
                    <a href="../service/agreement.php?code=001003" target="_blank">전체보기</a>
                </p>
                ...
                if ($('input[name="RnCheckType"]').length > 0) {
                    switch ($('input[name="RnCheckType"]:checked').val()) {
                        ...
                        case  'authCellPhone' :
                            ...
                            var callbackUrl = "http://samplejinana33.godomall.com/member/authcellphone/dreamsecurity_result.php";
                            ifrmHpauth.location.href = protocol + "//hpauthdream.godo.co.kr/module/NEW_hpauthDream_Main.php?callType=joinmember&shopUrl=" + callbackUrl + "&cpid=";
                            break;
                        default :
                            alert("본인인증이 필요합니다.");
        ...
        $('.terms-view :checkbox', $formTerms).change(function (e) {
            ...
            if (isTargetChecked) {
                if (isTermsAgreeSelect) {
                    ...
                    $termsView.find('.consignment-box :checkbox').val('y');
                } else {
                    $target.val('y');
                    $label.addClass('on');
                }
