...
public class PageMaker {
    ...
    private void calcData() {
        ...
        next = endPage * criteria.getPageNum() >= totalCount ? false : true;

    }

    public String makeQuery(int page) {
    	UriComponentsBuilder uriComponents = UriComponentsBuilder.newInstance();
    	if (criteria.getCateCd() != null) {
    		uriComponents.queryParam("cateCd", criteria.getCateCd());
    	}
    	uriComponents.queryParam("page", page);
    	if (criteria.getSort() != null) {
    		uriComponents.queryParam("sort", criteria.getSort());
    	}
    	uriComponents.queryParam("pageNum", criteria.getPageNum());
    	if (criteria.getKeyword() != null) {
    		uriComponents.queryParam("keyword", criteria.getKeyword());
    	}
    	uriComponents.build();
